...
class CertificateParameters(BaseModel):
    field_unique_code: str = Field(
        ..., alias='_unique_code', description='Unique Code', examples=['7L017C']
    )
...
class EtcerCertificatePostRequest(BaseModel):
...
class EtcerCertificatePostResponse(BaseModel):
...
class EtcerCertificatePostResponse1(BaseModel):
...
class EtcerCertificatePostResponse2(BaseModel):
...
class EtcerCertificatePostResponse3(BaseModel):
...
class EtcerCertificatePostResponse4(BaseModel):
...
class EtcerCertificatePostResponse5(BaseModel):
...
class EtcerCertificatePostResponse6(BaseModel):
    error: Optional[Error6] = None
    errorDescription: Optional[ErrorDescription6] = None


class CertificateParameters1(BaseModel):
    field_uniqueid: str = Field(
        ..., alias='_uniqueid', description='Unique Code', examples=['JANNAR']
    )
...
class CertificateParameters2(BaseModel):
    field_name: str = Field(
        ..., alias='_name', description='Name', examples=['Arjun Dev']
    )
    consumer_id: str = Field(..., description='Consumer ID', examples=['441947'])


class SicerCertificatePostRequest(BaseModel):
...
class SicerCertificatePostResponse(BaseModel):
...
class SicerCertificatePostResponse1(BaseModel):
...
class SicerCertificatePostResponse2(BaseModel):
...
class SicerCertificatePostResponse3(BaseModel):
...
class SicerCertificatePostResponse4(BaseModel):
...
class SicerCertificatePostResponse5(BaseModel):
...
class SicerCertificatePostResponse6(BaseModel):
